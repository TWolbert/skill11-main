...
export function Register() {
    ...
    return (
        <div className="flex flex-col items-center justify-center w-full h-screen gap-10 ">
            ...
            onSubmit={handleSubmit} action="http://localhost:8000/registration/register.php" method="POST" className="flex flex-col gap-2 px-20 py-10 bg-white border-2 border-solid shadow-md border-gray-600/30 rounded-xl">
                <p className="text-2xl font-oswald">Please register an account to continue</p>
                ...
                <div className="flex items-center justify-center gap-2 w-fit">
                    <input type="checkbox" checked={updated} onChange={(event) => setUpdated(event.target.checked)} name="updated" value={'updated'} />
                    <label htmlFor="updated" className="text-xl ">Keep me updated!</label>
                </div>
            ...
            <Link to={'/login'} className="text-blue-500 hover:underline">I already have an account</Link>
        </div>
    )
}